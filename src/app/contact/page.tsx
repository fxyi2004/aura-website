  ...
  return (
    <div className="contact-page">
        ...
        <div className="layout">
          ...
          <div className="sidebar">
            <div className="sidebar-top">
              <p className="sidebar-label">CONTACT US</p>
              <h1 className="sidebar-title">与我们对话</h1>
              <p className="sidebar-desc">无论您正在规划项目、评估方案，还是已有明确采购需求，我们将在一个工作日内回复您。</p>
            </div>
            ...
            <div className="contact-methods">
              ...
              <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer" className="method-item">
                ...
                <div>
                  <div className="method-label">即时沟通</div>
          ...
          <div className="form-panel">
            {submitted ? (
              <div className="success-state">
                ...
                <h3>消息已发送</h3>
                <p>我们已收到您的需求，技术顾问将尽快与您联系。</p>
                <button className="reset-btn" onClick={() => setSubmitted(false)}>再次提交</button>
              </div>
            ) : (
              <form onSubmit={handleSubmit}>
                <div className="form-header">
                  <h2>提交需求</h2>
                  <p>填写以下信息，我们将为您定制解决方案</p>
                </div>

                <div className="fields">
                  <div className="field-row">
                    <div className="field">
                      <label>Name / 姓名 <span className="required">*</span></label>
                  ...
                  <div className="field-row">
                    ...
                    <div className="field">
                      <label>Scenario / 感兴趣的场景</label>
                      <select name="scenario">
                        <option value="">Select a scenario...</option>
                        <option>Island Logistics / 海岛物流</option>
                        <option>Mountain Cargo / 山区运输</option>
                        <option>Smart Agriculture / 智慧农业</option>
                        <option>Emergency Response / 应急救援</option>
                        <option>Water Survey & Security / 水域巡检</option>
                        <option>Smart Campus & Park / 智慧园区</option>
                      </select>
                    </div>
                  </div>

                  <div className="field">
                    <label>Message / 需求描述 <span className="required">*</span></label>
                    <textarea name="message" placeholder="Describe your application scenario, equipment needs, quantity, and expected delivery timeline..." rows={9} required />
                  </div>
                </div>
      ...
      <style jsx>{`
        ...
        .checkbox-label:hover { border-color: #2563eb; background: white; }
        .checkbox-label input { accent-color: #1e3a8a; width: 14px; height: 14px; flex-shrink: 0; }
